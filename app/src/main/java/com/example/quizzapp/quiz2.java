...
public class quiz2 extends AppCompatActivity {
    ...
    static int x=1;
    String good=null;
    String RepCorrect="Sydney, Australia";
    FirebaseFirestore db= FirebaseFirestore.getInstance();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        DocumentReference document=db.collection("Questions").document("2");
        ...
        document.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()){
                    ...
                    Toast.makeText(quiz2.this,"Row not found",Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(quiz2.this,"Failed to fetch data",Toast.LENGTH_SHORT).show();
            }
        });
